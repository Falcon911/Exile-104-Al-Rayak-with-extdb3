	...
	*/
	class Military
	{
		...
		items[] = 
		{
			...
			{6939.01421918508, "rhs_weap_M590_5RD"}, // 0.17%
			...
			{7021.52247001016, "rhs_weap_m4a1"}, // 0.17%
			{7038.02412017518, "U_I_GhillieSuit"}, // 0.17%
			{7054.52577034019, "rhs_weap_kar98k"}, // 0.17%
			{7071.02742050521, "rhs_weap_m38"}, // 0.17%
			{7087.52907067022, "muzzle_snds_B"}, // 0.17%
			{7104.03072083524, "U_O_GhillieSuit"}, // 0.17%
			{7120.53237100026, "hlc_rifle_FAL5000"}, // 0.17%
			...
			{7184.25804858732, "hlc_rifle_G36A1"}, // 0.16%
			{7199.81674731433, "hlc_rifle_aug"}, // 0.16%
			{7215.37544604135, "hlc_rifle_aek971"}, // 0.16%
			{7230.93414476837, "hlc_rifle_g3a3"}, // 0.16%
			...
			{7703.09171859527, "ACE_NVG_Gen1"}, // 0.14%
			{7716.86700916781, "ACE_NVG_Gen2"}, // 0.14%
			{7730.64229974035, "NVGoggles"}, // 0.14%
			{7744.41759031288, "ACE_NVG_Gen4"}, // 0.14%
			{7758.19288088542, "ACE_NVG_Wide"}, // 0.14%
			...
			{9821.83391114743, "hlc_smg_9mmar"}, // 0.03%
	...
	*/
	class Radiation
	{
		...
		items[] = 
		{
			...
			{7497.82675136888, "hlc_lmg_M60E4"}, // 0.73%
			{7571.08682462896, "hlc_lmg_M249E2"}, // 0.73%
			{7644.34689788903, "hlc_lmg_MG42"}, // 0.73%
			...
			{8043.75927442559, "hlc_lmg_minimi_railed"}, // 0.49%
			{8092.59932326564, "rhs_weap_m240G"}, // 0.49%
			...
			{8559.80219248192, "rhs_weap_pkm"}, // 0.26%
			{8586.25721893695, "rhs_weap_pkp"}, // 0.26%
			{8612.71224539198, "rhs_weap_M590_8RD"}, // 0.26%
			{8639.16727184701, "sfp_ksp58"}, // 0.26%
			{8665.62229830203, "sfp_ksp90c"}, // 0.26%
			{8692.07732475706, "sfp_psg90_camo"}, // 0.26%
