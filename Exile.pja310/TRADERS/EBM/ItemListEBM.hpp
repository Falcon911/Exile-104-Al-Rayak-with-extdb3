...
//////////////////////////////////////////////////////////////////////////////
class EBM_Item_Bucket_Of_Mortar								{ quality = 1; price = 200; sellPrice = 50; };
class EBM_Item_Bricks										{ quality = 1; price = 200; sellPrice = 50; };
class Land_HBarrier_1_F_Kit									{ quality = 1; price = 5500; sellPrice = 500; };
class Land_HBarrier_3_F_Kit									{ quality = 1; price = 12000; sellPrice = 500; };
class Land_HBarrier_5_F_Kit									{ quality = 1; price = 20000; sellPrice = 500; };
...
class Land_WaterCooler_01_new_F_Kit							{ quality = 2; price = 25000; sellPrice = 2500; };

///////////////////////// V0.0.3
class Land_Pallet_MilBoxes_F_Kit							{ quality = 1; price = 3000; sellPrice = 250; };
//class Land_Cargo20_military_green_F_Kit						{ quality = 1; price = 50000; sellPrice = 50; };
class Land_BagFence_Corner_F_Kit							{ quality = 1; price = 5000; sellPrice = 250; };
class Land_BagFence_Long_F_Kit								{ quality = 1; price = 1000; sellPrice = 250; };
//class Land_HBarrierTower_F_Kit								{ quality = 1; price = 75000; sellPrice = 50; };
class Land_Metal_wooden_rack_F_Kit							{ quality = 1; price = 3000; sellPrice = 250; };
...
class Land_Rack_F_Kit										{ quality = 1; price = 3000; sellPrice = 250; };

///////////////////////// V0.1.0
//class Land_City_Gate_F_Kit									{ quality = 1; price = 20000; sellPrice = 50; };
class Land_BarGate_F_Kit									{ quality = 1; price = 10000; sellPrice = 250; };
class Land_Icebox_F_Kit										{ quality = 1; price = 5000; sellPrice = 500; };
...
class Land_Cargo_Patrol_V2_F_Kit							{ quality = 2; price = 100000; sellPrice = 5000; };
...
class Land_ShelvesMetal_F_Kit								{ quality = 1; price = 5000; sellPrice = 250; };
class Land_Cargo_Tower_V2_F_Kit								{ quality = 1; price = 150000; sellPrice = 5000; };
class Land_FuelStation_Feed_F_Kit							{ quality = 2; price = 100000; sellPrice = 5000; };
...
///////////////////////// V0.1.3
class Land_cargo_house_slum_F_Kit							{ quality = 1; price = 2000; sellPrice = 50; };
//class Land_Cargo40_light_green_F_Kit						{ quality = 1; price = 130000; sellPrice = 50; };
class Land_Cargo_House_V2_F_Kit								{ quality = 1; price = 50000; sellPrice = 2500; };
class Land_LampHalogen_F_Kit								{ quality = 1; price = 5000; sellPrice = 500; };
...
class Land_Cargo20_sand_F_Kit								{ quality = 2; price = 80000; sellPrice = 5000; };
class Land_GH_Stairs_F_Kit									{ quality = 1; price = 5000; sellPrice = 250; };
...
class Land_TentHangar_V1_F_Kit								{ quality = 3; price = 150000; sellPrice = 5000; };
...
class Land_Water_source_F_Kit								{ quality = 2; price = 10000; sellPrice = 500; };
class Land_Sign_WarningMilitaryVehicles_F_Kit				{ quality = 1; price = 1000; sellPrice = 50; };
class Land_Sign_WarningMilAreaSmall_F_Kit					{ quality = 1; price = 1000; sellPrice = 50; };
...
///////////////////////// V0.1.7
class Land_PortableLight_double_F_Kit						{ quality = 1; price = 5000; sellPrice = 500; };
//class Land_Radar_Small_F_Kit								{ quality = 1; price = 150000; sellPrice = 50; };
class Land_Cargo_addon02_V2_F_Kit							{ quality = 1; price = 2000; sellPrice = 50; }; //Slumplane
class Land_TableDesk_F_Kit									{ quality = 1; price = 2000; sellPrice = 50; };
class Land_ToiletBox_F_Kit									{ quality = 1; price = 2000; sellPrice = 50; };
...
class Land_CargoBox_V1_F_Kit								{ quality = 2; price = 60000; sellPrice = 5000; };
...
class Land_LampStreet_F_Kit									{ quality = 1; price = 6000; sellPrice = 500; };
...
class Land_Sun_chair_F_Kit									{ quality = 1; price = 1000; sellPrice = 50; };
class Land_Sunshade_04_F_Kit								{ quality = 1; price = 2000; sellPrice = 50; };
class Land_LampShabby_F_Kit									{ quality = 1; price = 5000; sellPrice = 500; };
...
class Land_BeachBooth_01_F_Kit								{ quality = 1; price = 2000; sellPrice = 50; };
...
class Land_Sleeping_bag_F_Kit								{ quality = 1; price = 1000; sellPrice = 50; };
//class Land_Small_Stone_02_F_Kit								{ quality = 1; price = 23000; sellPrice = 50; };
class Land_SolarPanel_2_F_Kit								{ quality = 1; price = 3000; sellPrice = 250; };
class Land_spp_Panel_F_Kit									{ quality = 1; price = 3000; sellPrice = 250; };

///////////////////////// V0.2.3
class Land_CampingChair_V2_F_Kit							{ quality = 1; price = 1000; sellPrice = 50; };
class Land_CampingChair_V1_F_Kit							{ quality = 1; price = 1000; sellPrice = 50; };
class Land_Camping_Light_F_Kit								{ quality = 1; price = 3000; sellPrice = 250; };
class Land_CampingTable_F_Kit								{ quality = 1; price = 1000; sellPrice = 50; };
class MapBoard_altis_F_Kit									{ quality = 1; price = 2000; sellPrice = 50; };
...
class Land_Sink_F_Kit										{ quality = 1; price = 2500; sellPrice = 500; };

///////////////////////// V0.2.5
class Land_Atm_02_F_Kit										{ quality = 3; price = 100000; sellPrice = 5000; };
...
class Land_PlasticCase_01_medium_F_Kit						{ quality = 1; price = 3000; sellPrice = 250; };
...
///////////////////////// V0.2.8
class Land_Suitcase_F_Kit									{ quality = 2; price = 3000; sellPrice = 250; };
...
class Land_GamingSet_01_console_F_Kit						{ quality = 1; price = 1000; sellPrice = 50; };
class Land_GamingSet_01_controller_F_Kit					{ quality = 1; price = 1000; sellPrice = 50; };
class Land_GymBench_01_F_Kit								{ quality = 1; price = 2000; sellPrice = 50; };
class Land_GymRack_03_F_Kit									{ quality = 1; price = 2000; sellPrice = 50; };
...
class Land_PCSet_01_case_F_Kit								{ quality = 1; price = 2000; sellPrice = 50; };
class Land_PCSet_01_keyboard_F_Kit							{ quality = 1; price = 2000; sellPrice = 50; };
class Land_PCSet_01_mouse_F_Kit								{ quality = 1; price = 2000; sellPrice = 50; };
class Land_PCSet_01_screen_F_Kit							{ quality = 1; price = 2000; sellPrice = 50; };
...
class Land_Trophy_01_bronze_F_Kit							{ quality = 4; price = 30000; sellPrice = 15000; };
class Land_Trophy_01_gold_F_Kit								{ quality = 6; price = 100000; sellPrice = 50000; };
class Land_Trophy_01_silver_F_Kit							{ quality = 5; price = 50000; sellPrice = 25000; };
...
class Land_DieselGroundPowerUnit_01_F_Kit					{ quality = 1; price = 2000; sellPrice = 50; };
class Land_EngineCrane_01_F_Kit								{ quality = 1; price = 2000; sellPrice = 50; };
class Land_PalletTrolley_01_yellow_F_Kit					{ quality = 1; price = 2000; sellPrice = 50; };
class Land_PressureWasher_01_F_Kit							{ quality = 1; price = 2000; sellPrice = 50; };
class Land_WeldingTrolley_01_F_Kit							{ quality = 1; price = 3000; sellPrice = 50; };
...
class PlasticBarrier_02_grey_F_Kit							{ quality = 1; price = 3000; sellPrice = 50; };
class PlasticBarrier_02_yellow_F_Kit						{ quality = 1; price = 3000; sellPrice = 50; };
class PlasticBarrier_03_blue_F_Kit							{ quality = 1; price = 3000; sellPrice = 50; };
class PlasticBarrier_03_orange_F_Kit						{ quality = 1; price = 3000; sellPrice = 50; };
...
class Land_Target_Dueling_01_F_Kit							{ quality = 1; price = 3000; sellPrice = 250; };
class TargetP_Inf_F_Kit										{ quality = 1; price = 3000; sellPrice = 250; };
class Fridge_01_closed_F_Kit								{ quality = 1; price = 2000; sellPrice = 50; };
class Land_MetalCase_01_large_F_Kit							{ quality = 1; price = 5000; sellPrice = 250; };
class Land_Microwave_01_F_Kit								{ quality = 1; price = 1000; sellPrice = 50; };
class Land_ShelvesWooden_F_Kit								{ quality = 1; price = 5000; sellPrice = 250; };
class Land_ShelvesWooden_blue_F_Kit							{ quality = 1; price = 5000; sellPrice = 250; };
class Land_ShelvesWooden_khaki_F_Kit						{ quality = 1; price = 5000; sellPrice = 250; };
class Land_ToolTrolley_01_F_Kit								{ quality = 1; price = 2000; sellPrice = 50; };
class Land_ToolTrolley_02_F_Kit								{ quality = 1; price = 2000; sellPrice = 50; };
class Land_Sign_Mines_F_Kit									{ quality = 1; price = 1000; sellPrice = 50; };
class Land_PortableHelipadLight_01_F_Kit					{ quality = 1; price = 10000; sellPrice = 250; };
class PortableHelipadLight_01_blue_F_Kit					{ quality = 1; price = 10000; sellPrice = 250; };
class PortableHelipadLight_01_green_F_Kit					{ quality = 1; price = 10000; sellPrice = 250; };
class PortableHelipadLight_01_red_F_Kit						{ quality = 1; price = 10000; sellPrice = 250; };
class PortableHelipadLight_01_white_F_Kit					{ quality = 1; price = 10000; sellPrice = 250; };
class PortableHelipadLight_01_yellow_F_Kit					{ quality = 1; price = 10000; sellPrice = 250; };
class Land_GamingSet_01_powerSupply_F_Kit					{ quality = 1; price = 2000; sellPrice = 50; };
class Land_GamingSet_01_camera_F_Kit						{ quality = 1; price = 2000; sellPrice = 50; };
class WaterPump_01_forest_F_Kit								{ quality = 1; price = 5000; sellPrice = 50; };
class WaterPump_01_sand_F_Kit								{ quality = 1; price = 5000; sellPrice = 50; };
class Land_TripodScreen_01_large_F_Kit						{ quality = 1; price = 2000; sellPrice = 50; };
class Land_TripodScreen_01_dual_v2_F_Kit					{ quality = 1; price = 2000; sellPrice = 50; };
class Land_TripodScreen_01_dual_v1_F_Kit					{ quality = 1; price = 2000; sellPrice = 50; };
...
class Land_SatelliteAntenna_01_F_Kit						{ quality = 1; price = 1000; sellPrice = 50; };
//class Land_Projector_01_F_Kit								{ quality = 3; price = 1000; sellPrice = 50; };
class Land_PortableGenerator_01_F_Kit						{ quality = 2; price = 20000; sellPrice = 500; };
//class Land_Obstacle_Ramp_F_Kit								{ quality = 1; price = 10000; sellPrice = 50; };
class MetalBarrel_burning_F_Kit								{ quality = 1; price = 10000; sellPrice = 500; };
...
class EBM_Brickwall_floorport_Kit							{ quality = 1; price = 1250; sellPrice = 50; };
...
///////////////////////// V0.3.4
class EBM_Metalwall_window_Kit								{ quality = 5; price = 20000; sellPrice = 50; };
class EBM_Metalwall_stairs_Kit								{ quality = 5; price = 10000; sellPrice = 50; };
class EBM_Metalwall_floorport_door_Kit						{ quality = 5; price = 20000; sellPrice = 50; };
class EBM_Metalwall_floorport_Kit							{ quality = 5; price = 12000; sellPrice = 50; };
class EBM_Metalwall_floor_Kit								{ quality = 5; price = 10000; sellPrice = 50; };
class EBM_Metalwall_door_Kit								{ quality = 5; price = 20000; sellPrice = 50; };
class EBM_Metalwall_hole_Kit								{ quality = 5; price = 15000; sellPrice = 50; };
class EBM_Metalwall_half_Kit								{ quality = 5; price = 5000; sellPrice = 50; };
...
class EBM_ATM_Kit											{ quality = 3; price = 100000; sellPrice = 5000; };