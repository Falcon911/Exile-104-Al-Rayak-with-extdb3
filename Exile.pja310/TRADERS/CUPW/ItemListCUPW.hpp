	...
	// Assault rifle
	///////////////////////////////////////////////////////////////////////////////
	class CUP_arifle_AK107									{ quality = 1; price = 802; };
	class CUP_arifle_AK107_GL								{ quality = 1; price = 1027; };
	class CUP_arifle_AK74									{ quality = 1; price = 784; };
	class CUP_arifle_AK74_GL								{ quality = 1; price = 1009; };
	class CUP_arifle_AKM									{ quality = 1; price = 815; };
	class CUP_arifle_AKS									{ quality = 1; price = 815; };
	...
	class CUP_arifle_G36A_camo								{ quality = 1; price = 820; };
	class CUP_arifle_G36C									{ quality = 1; price = 896; };
	class CUP_arifle_G36C_camo								{ quality = 1; price = 896; };
	class CUP_arifle_G36K									{ quality = 1; price = 926; };
	class CUP_arifle_G36K_camo								{ quality = 1; price = 926; };
	class CUP_arifle_L85A2									{ quality = 1; price = 894; };
	class CUP_arifle_L85A2_GL								{ quality = 1; price = 1144; };
	class CUP_arifle_L86A2									{ quality = 1; price = 1385; };
	class CUP_arifle_M16A2									{ quality = 1; price = 400; };
	class CUP_arifle_M16A2_GL								{ quality = 1; price = 650; };
	class CUP_arifle_M16A4GL								{ quality = 1; price = 1144; };
	class CUP_arifle_M16A4_Base								{ quality = 1; price = 894; };
	class CUP_arifle_M16A4_GL								{ quality = 1; price = 1144; };
	class CUP_arifle_M4A1									{ quality = 1; price = 926; };
	class CUP_arifle_M4A1_BUIS_GL							{ quality = 1; price = 1144; };
	class CUP_arifle_M4A1_BUIS_camo_GL						{ quality = 1; price = 1144; };
	class CUP_arifle_M4A1_BUIS_desert_GL					{ quality = 1; price = 1144; };
	class CUP_arifle_M4A1_black								{ quality = 1; price = 926; };
	class CUP_arifle_M4A1_camo								{ quality = 1; price = 926; };
	class CUP_arifle_M4A1_desert							{ quality = 1; price = 926; };
	class CUP_arifle_MG36									{ quality = 1; price = 1144; };
	class CUP_arifle_MG36_camo								{ quality = 1; price = 1144; };
	class CUP_arifle_Mk16_CQC								{ quality = 2; price = 1059; };
	class CUP_arifle_Mk16_CQC_EGLM							{ quality = 2; price = 1359; };
	class CUP_arifle_Mk16_CQC_FG							{ quality = 2; price = 1059; };
	class CUP_arifle_Mk16_CQC_SFG							{ quality = 2; price = 1059; };
	class CUP_arifle_Mk16_STD								{ quality = 2; price = 1059; };
	class CUP_arifle_Mk16_STD_EGLM							{ quality = 2; price = 1359; };
	class CUP_arifle_Mk16_STD_FG							{ quality = 2; price = 1059; };
	class CUP_arifle_Mk16_STD_SFG							{ quality = 2; price = 1059; };
	class CUP_arifle_Mk16_SV								{ quality = 2; price = 1059; };
	class CUP_arifle_Mk17_CQC								{ quality = 2; price = 1159; };
	class CUP_arifle_Mk17_CQC_EGLM							{ quality = 2; price = 1459; };
	class CUP_arifle_Mk17_CQC_FG							{ quality = 2; price = 1159; };
	class CUP_arifle_Mk17_CQC_SFG							{ quality = 2; price = 1159; };
	class CUP_arifle_Mk17_STD								{ quality = 2; price = 1159; };
	class CUP_arifle_Mk17_STD_EGLM							{ quality = 2; price = 1159; };
	class CUP_arifle_Mk17_STD_FG							{ quality = 2; price = 1159; };
	class CUP_arifle_Mk17_STD_SFG							{ quality = 2; price = 1159; };
	class CUP_arifle_Mk20									{ quality = 2; price = 1159; };
	class CUP_arifle_RPK74									{ quality = 1; price = 1027; };
	class CUP_arifle_Sa58P									{ quality = 1; price = 1359; };
	class CUP_arifle_Sa58P_des								{ quality = 1; price = 1359; };
	class CUP_arifle_Sa58RIS1								{ quality = 1; price = 1359; };
	class CUP_arifle_Sa58RIS2								{ quality = 1; price = 1359; };
	class CUP_arifle_Sa58RIS2_camo							{ quality = 1; price = 1359; };
	class CUP_arifle_Sa58V									{ quality = 1; price = 1359; };
	class CUP_arifle_Sa58V_camo								{ quality = 1; price = 1359; };
	class CUP_arifle_XM8_Carbine							{ quality = 1; price = 1059; };
	class CUP_arifle_XM8_Carbine_FG							{ quality = 1; price = 1059; };
	class CUP_arifle_XM8_Carbine_GL							{ quality = 1; price = 1359; };
	class CUP_arifle_XM8_Compact							{ quality = 1; price = 1059; };
	class CUP_arifle_XM8_Compact_Rail						{ quality = 1; price = 1059; };
	class CUP_arifle_XM8_Railed								{ quality = 1; price = 1059; };
	class CUP_arifle_xm8_SAW								{ quality = 1; price = 1059; };
	class CUP_arifle_xm8_sharpshooter						{ quality = 1; price = 1059; };
	class CUP_sgun_AA12										{ quality = 3; price = 6000; };
	class CUP_sgun_M1014									{ quality = 1; price = 959; };
	class CUP_sgun_Saiga12K									{ quality = 1; price = 1200; };
/*	class CUP_arifle_AK107_GL_kobra							{ quality = 1; price = 400; }; // Dupe bug
	...
	// Hand Guns
	///////////////////////////////////////////////////////////////////////////////
	class CUP_hgun_Colt1911									{ quality = 1; price = 80; };
	class CUP_hgun_Compact									{ quality = 1; price = 80; };
	class CUP_hgun_Duty										{ quality = 1; price = 650; };
	class CUP_hgun_Glock17									{ quality = 1; price = 69; };
	class CUP_hgun_M9										{ quality = 1; price = 69; };
	class CUP_hgun_Makarov									{ quality = 1; price = 65; };
	class CUP_hgun_MicroUzi									{ quality = 1; price = 106; };
	class CUP_hgun_PB6P9									{ quality = 1; price = 629; };
	class CUP_hgun_Phantom									{ quality = 1; price = 650; };
	class CUP_hgun_SA61										{ quality = 1; price = 103; };
	class CUP_hgun_TaurusTracker455							{ quality = 1; price = 72; };
	class CUP_hgun_TaurusTracker455_gold					{ quality = 1; price = 72; };
/*	class CUP_hgun_Colt1911_snds							{ quality = 1; price = 200; }; // Dupe bug
	...
	// Light Machine Gun
	///////////////////////////////////////////////////////////////////////////////
	class CUP_lmg_L110A1									{ quality = 1; price = 1649; };
	class CUP_lmg_L7A2										{ quality = 2; price = 2422; };
	class CUP_lmg_M240										{ quality = 2; price = 2422; };
	class CUP_lmg_M249										{ quality = 1; price = 1822; };
	class CUP_lmg_M249_para									{ quality = 1; price = 1959; };
	class CUP_lmg_Mk48_des									{ quality = 2; price = 2519; };
	class CUP_lmg_Mk48_wdl									{ quality = 2; price = 2519; };
	class CUP_lmg_PKM										{ quality = 1; price = 2515; };
	class CUP_lmg_Pecheneg									{ quality = 2; price = 2019; };
	class CUP_lmg_UK59										{ quality = 1; price = 1296; };
/*	class CUP_lmg_L110A1_Aim_Laser							{ quality = 1; price = 300; }; // Dupe bug
	...
	// Sub Machine Gun
	///////////////////////////////////////////////////////////////////////////////
	class CUP_smg_EVO										{ quality = 1; price = 387; };
	class CUP_smg_MP5A5										{ quality = 1; price = 375; };
	class CUP_smg_MP5SD6									{ quality = 1; price = 392; };
	class CUP_smg_bizon										{ quality = 1; price = 420; };
/*	class CUP_smg_EVO_MRad_Flashlight						{ quality = 1; price = 250; }; // Dupe bug
	...
	//	Sniper Rifle
	///////////////////////////////////////////////////////////////////////////////
	class CUP_srifle_AS50									{ quality = 6; price = 6495; };
	class CUP_srifle_AWM_des								{ quality = 5; price = 5059; };
	class CUP_srifle_AWM_wdl								{ quality = 5; price = 5059; };
	class CUP_srifle_CZ550									{ quality = 1; price = 1500; };
	class CUP_srifle_CZ750									{ quality = 1; price = 1500; };
	class CUP_srifle_DMR									{ quality = 1; price = 3459; };
	class CUP_srifle_LeeEnfield								{ quality = 1; price = 1500; };
	class CUP_srifle_M107_Base								{ quality = 5; price = 5859; };
	class CUP_srifle_M110									{ quality = 2; price = 4167; };
	class CUP_srifle_M14									{ quality = 1; price = 3459; };
	class CUP_srifle_M24_des								{ quality = 1; price = 3459; };
	class CUP_srifle_M24_wdl								{ quality = 1; price = 3459; };
	class CUP_srifle_M40A3									{ quality = 1; price = 3459; };
	class CUP_srifle_Mk12SPR								{ quality = 1; price = 3459; };
	class CUP_srifle_SVD									{ quality = 1; price = 3459; };
	class CUP_srifle_SVD_des								{ quality = 1; price = 3459; };
	class CUP_srifle_VSSVintorez							{ quality = 2; price = 3459; };
	class CUP_srifle_ksvk									{ quality = 5; price = 5859; };
/*	class CUP_srifle_AS50_AMPAS13c2							{ quality = 1; price = 1500; }; // Dupe bug
	...
	//	Grenade Launchers
	///////////////////////////////////////////////////////////////////////////////
	class CUP_glaunch_6G30									{ quality = 1; price = 1900; };
	class CUP_glaunch_M32									{ quality = 2; price = 3900; };
	class CUP_glaunch_M79									{ quality = 1; price = 1000; };
	class CUP_glaunch_Mk13									{ quality = 1; price = 2900; };
 ...
 class CUP_launch_9K32Strela								{ quality = 2; price = 5000; }; // Dupe bug
	...
	class CUP_launch_RPG7V									{ quality = 1; price = 3000; }; // Dupe bug 
	...
	//class CUP_optic_AN_PVS_10								{ quality = 1; price = 50; };> -- thermal
	class CUP_optic_AN_PVS_4								{ quality = 1; price = 50; };
	class CUP_optic_CWS										{ quality = 6; price = 5000; };
	...
	//class CUP_optic_GOSHAWK									{ quality = 1; price = 50; }; <-- thermal
