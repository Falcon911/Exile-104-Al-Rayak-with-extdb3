...
salvageVehicle_GIVE_JUNK_PERCENTAGE		= 80;
...
salvageVehicle_givenJunkCar				= [["Exile_Item_JunkMetal", 2],["Exile_Item_MetalPole", 2],["Exile_Item_MetalBoard", 3]];

// Set the Junk returned to the player for salvaging a Tank only.
salvageVehicle_givenJunkTank			= [["Exile_Item_JunkMetal", 4],["Exile_Item_MetalPole", 6],["Exile_Item_MetalBoard", 10]];

// Set the Junk returned to the player for salvaging an Aircraft only.
salvageVehicle_givenJunkAir				= [["Exile_Item_JunkMetal", 2],["Exile_Item_MetalPole", 3],["Exile_Item_MetalBoard", 6]];

// Set the Junk returned to the player for salvaging a Boat only.
salvageVehicle_givenJunkShip			= [["Exile_Item_JunkMetal", 1],["Exile_Item_MetalPole", 5],["Exile_Item_MetalBoard", 2]];
